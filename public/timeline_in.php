...
// タイムライン表示対象のユーザーIDリストを取得（IN句を使用する方式）
...
// array_mapでfollowee_user_idカラムのみを抽出して配列を作成
...
// 動的にプレースホルダ（?）を生成：要素数分の「?」をカンマ区切りで連結
...
$select_sth->execute($target_user_ids); // IN句のプレースホルダに配列の値をバインド
